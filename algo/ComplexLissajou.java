...
public class ComplexLissajou extends Algorithm
{
	public ComplexLissajou(GestionPistes gp)
	{
		super(gp,TYPE_GEN,"complexlissajou","Complex Lissajou","Generates a Lissajou curve. On each axis, a different sinusoidal wave drives the curve with initial and final properties (frequency,amplitude,phase).\n(Continue pastes it at the end, Replace replaces it)");
