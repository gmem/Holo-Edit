...
public class HoloEditMXJ extends MaxObject implements Executable,Player
{
	...
	protected void initObj()
	{
		...
		holoedit = new HoloEdit(false);
		
		soundPool = holoedit.soundPoolGui;
		gestionPistes = holoedit.gestionPistes;
